...
public class TaskScheduler {
    public static void main(String[] args) {
        ...
        File rootDir = new File("BorderH");
        File[] files = rootDir.listFiles();
        Mat a = Imgcodecs.imread("BorderH/BorderH_threshold32749.jpg");
        Imgcodecs.imwrite("dupa.jpg", a);
        BufferedImage buffer = FormatConverter.MatToBufferImage(a);
...
//
//
//        List<Mat> a = listOfImages.parallelStream()
